...
public final class PicGraphics {
	...
	/**
	 * Holds mapping between RBG colour values and their EGA palette index value. 
	 */
    ...
    /**
     * Creates the image for the screen on which all of the graphics
     * routines will operate on.
     */
	 ...
	 * quickly converting between a pixel on the screen and the associated
	 * EGA colour.
	 */
	...
	/**
	 * Draws the given array of RGB values into the screen at the given
	 * offset, doubling each pixel as it goes.
	 * 
	...
	/**
	 * Checks whether the frame should be drawn based on the frame rate. If 
	 * so then it draws the frame.
	 */
	...
	/**
	 * Draws a line in the 320 x 200 PICEDIT coordinate system. Used
	 * primarily for drawing the interface components (the AGI picture
	 * uses the version in the Picture class).
	 * 
	...
	/**
	 * Draws a message box, i.e. a white box with a black border indented slightly,
	 * as per the original Sierra games.
	 *  
	...
	/**
	 * Draws a temporary picture line. These are the lines that are 
	 * drawn while a line drawing tool is active (line, pen, step). The 
	 * line follows the mouse's movements and allows the user to see 
	 * where the line is going to fall if they click in that position.
	 * 
	 * @param x1 Start X Coordinate.
	 * @param y1 Start Y Coordinate.
	 * @param x2 End X Coordinate.
